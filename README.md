...
Intersections: Custom math for Ray-Sphere and Ray-AABB. Includes a basic caching mechanism for fast AABB checks.

Materials: Support for diffuse, metallic, and refractive (dielectric) surfaces.

Stack: C23, OpenGL 4.3+, Raylib / rlgl.
